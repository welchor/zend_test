...
class __Mustache_28ec6aed6e26bf3b68a6711f457ab414 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div class="gallery-item ';
        // 'fav_page' section
        $value = $context->find('fav_page');
        $buffer .= $this->section52844952249b3343fc5c45a9a177c0ee($context, $indent, $value);
        $buffer .= ' themed">
';
        $buffer .= $indent . '	<div class="img-ph loading">
';
        $buffer .= $indent . '		<img class="themed lazy_';
        // 'page' section
        $value = $context->find('page');
        $buffer .= $this->sectionE6f9271a872b3ee354df45dc76e5ad0b($context, $indent, $value);
...
';
    ...
    private function section52844952249b3343fc5c45a9a177c0ee(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionE6f9271a872b3ee354df45dc76e5ad0b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '{{page}}';
