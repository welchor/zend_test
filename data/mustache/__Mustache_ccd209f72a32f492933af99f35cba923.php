...
class __Mustache_ccd209f72a32f492933af99f35cba923 extends Mustache_Template
{
...
';
        ...
        $buffer .= $indent . '	</div>
';
        $buffer .= $indent . '	<div class="gallery-quick-view"><div class="action-button small quick-view" id="quick_view_';
        $value = $this->resolveValue($context->find('template_id'), $context, $indent);
        $buffer .= htmlspecialchars($value, 2, 'UTF-8');
        $buffer .= '">Quick View</div></div>	
';
        $buffer .= $indent . '</div>
';
        $buffer .= $indent . '
